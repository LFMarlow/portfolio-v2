...
// Generates into <div id="arch-diagram">
// Tooltip via #arch-tooltip (positioned on hover)
// Layout: Proxmox frame > WAN > pfSense > 3 VLANs side by side
// Corrected topology:
//   DMZ  = Bastion + Reverse Proxy
//   SRV  = MariaDB M/S, LAMP x2, Zabbix, GLPI
//   LAN  = Wazuh Manager
//   Suricata integrated in pfSense
// ============================================================
...
(function () {
  ...
  // Row 2: LAMP (inside Terraform box)
  ...
  // Terraform Provisioned box (dashed, around LAMPs)
  var tfX = srvL - 6;
  var tfY = row2Y - 6;
